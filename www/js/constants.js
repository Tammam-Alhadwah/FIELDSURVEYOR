...
export const BUMP_THRESHOLD_RAW     = 18;   // m/s² — raw accel incl. gravity (default)
export const BUMP_THRESHOLD_CLEAN   = 8;    // m/s² — gravity-free linear accel (default)
...
// ── Sensitivity presets ────────────────────────────────────────────────────────
// clean = gravity-free threshold (m/s²)
// raw   = raw-accel-with-gravity threshold (m/s²)
export const SENSITIVITY_PRESETS = {
  high:   { clean: 5,  raw: 12, label: 'HIGH'   },
  medium: { clean: 8,  raw: 18, label: 'MEDIUM'  },
  low:    { clean: 12, raw: 25, label: 'LOW'     },
};
